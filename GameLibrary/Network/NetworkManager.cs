...
namespace GameLibrary.Network
{
    public class NetworkManager
    {
        ...
        private void OnDataGot(object data)
        {
            ...
            if (bulletData != null)
            {
                Game.instance.AddObjectOnScene(
                    BulletFactory.CreateBullet(new OpenTK.Vector2(bulletData.SpawnPosition[0], bulletData.SpawnPosition[1]),
                    new OpenTK.Vector2(bulletData.Direction[0], bulletData.Direction[1]), 
                    bulletData.Tag, bulletData.Power));
            }
